                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex-shrink-0 flex items-center gap-2">
                        <Link to="/" className="flex items-center gap-2">
                            <img src="/src/assets/icons.png" alt="Marketo Logo" className="h-8 w-auto object-contain" />
                        </Link>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-6 lg:space-x-10 xl:space-x-14">
                        {navLinks.map((link, index) => (
                            <NavLink
                                ...
                                to={link.path}
                                className={({ isActive }) =>
                                    `text-base font-medium transition-colors hover:text-red-500 ${isActive ? 'text-red-500' : 'text-gray-700'
                                    }`
                                }
                            >
                                {link.title}

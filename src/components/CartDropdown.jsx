    ...
    return (
        ...
        >
            <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50 flex-shrink-0">
                <h4 className="font-bold text-slate-800">Shopping Cart</h4>
                <span className="text-xs bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-bold">{cartCount} Items</span>
            </div>
            <Content />
        </motion.div>
    );
